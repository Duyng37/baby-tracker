...
const shapes = {
  ...
  expense: <><path d="M4 7a2 2 0 0 1 2-2h12v4M4 7v11a2 2 0 0 0 2 2h14V9H6a2 2 0 0 1-2-2Z" /><circle cx="16" cy="14.5" r="1.2" /></>,
  clothes: <path d="M9 3a3 3 0 0 0 6 0l5 3-2 4-2-1v12H8V9l-2 1-2-4Z" />,
  education: <><path d="m2 9 10-5 10 5-10 5ZM6 11v5c3 3 9 3 12 0v-5M22 9v6" /></>,
  toys: <><circle cx="12" cy="12" r="9" /><path d="M12 3v18M3 12h18M5.6 5.6c3 3 3 9.8 0 12.8M18.4 5.6c-3 3-3 9.8 0 12.8" /></>,
